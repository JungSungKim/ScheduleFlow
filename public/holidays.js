/* ================================================
   ScheduleFlow — Holidays Data (2024~2029)
   대한민국 공휴일 정적 데이터
   ================================================ */
...
const KR_HOLIDAYS_MAP = {
  ...
  '2027-03-01': '3·1절', '2027-03-03': '대통령선거', 
  ...
  '2028-06-06': '현충일', 
  '2028-08-15': '광복절', 
  '2028-10-02': '추석 연휴', '2028-10-03': '추석/개천절', '2028-10-04': '추석 연휴', '2028-10-05': '대체공휴일(추석/개천절)', 
  '2028-10-09': '한글날', 
  '2028-12-25': '기독탄신일',
  // 2029
  '2029-01-01': '신정', 
...
function getHolidayName(dateStr) {
  return KR_HOLIDAYS_MAP[dateStr] || null;
}
